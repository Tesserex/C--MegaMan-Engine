...
namespace MegaMan.Engine.Tests.Components
{
    ...
    public class CollisionComponentTests : ComponentTestBase
    {
        ...
        public void Collision_FloatingPointError_StillWorks()
        {
            ...
            var tileset = new Tileset { TileSize = 16 };
            var backTile = new Tile(1, new TileSprite(tileset));
            ...
            var blockTile = new Tile(2, new TileSprite(tileset));
            blockTile.Properties = new TileProperties { Blocking = true };
