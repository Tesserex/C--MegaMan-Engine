...
namespace MegaMan.Engine
{
    public class MapHandler : IHandleGameEvents
    {
        ...
        {
            Game.CurrentGame.Player.Entity.Paused = true;
        ...
        public void StartHandler()
        {
            ...
            Game.CurrentGame.Player.ResetEntity();
            


            Game.CurrentGame.Player.Entity.Stopped += Player_Death;
            PlayerPos = Game.CurrentGame.Player.Entity.GetComponent<PositionComponent>();
            ...
            Game.CurrentGame.Player.Entity.Start();
